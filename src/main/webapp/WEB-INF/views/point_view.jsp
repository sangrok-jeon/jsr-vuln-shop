...
<head>
    ...
    .point-header { margin-bottom:24px; padding-bottom:16px; border-bottom:1px solid #334155; }
    .point-header h2 { font-size:1.3rem; margin:0; }
    ...
    .pb-value  { font-size:2.2rem; font-weight:800; color:#38bdf8; font-family:monospace; letter-spacing:-1px; line-height:1; }
    .pb-unit   { font-size:15px; color:#64748b; margin-left:4px; font-family:inherit; font-weight:400; }

    /* 게이지 */
    .progress-wrap { margin-bottom:20px; }
    .progress-bar-bg { background:#0f172a; border-radius:100px; height:6px; overflow:hidden; margin-bottom:4px; }
    .progress-bar-fill {
        height:100%; border-radius:100px;
        background:linear-gradient(90deg,#38bdf8,#6366f1); transition:width 0.4s ease;
    }
    .progress-label { font-size:11px; color:#475569; text-align:right; }
/* 알림 */
    .alert { padding:10px 16px; border-radius:8px; font-size:13px; margin-bottom:18px; line-height:1.6; }
    ...
    .action-card { background:#1e293b; border:1px solid #334155; border-radius:12px; padding:22px; }
    .action-card h3 {
        font-size:14px; font-weight:700; color:#f1f5f9;
        margin-bottom:8px; padding-bottom:10px; border-bottom:1px solid #334155;
        display:flex; align-items:center; gap:8px;
    }
    .limit-note {
        font-size:11px; color:#64748b; margin-bottom:12px;
        padding:7px 10px; background:#0f172a; border-radius:6px; border:1px solid #1e293b;
        line-height:1.6;
    }
    .limit-note strong { color:#94a3b8; }

    .quick-btns { display:flex; flex-wrap:wrap; gap:7px; margin-bottom:12px; }
    .quick-btn {
        background:#263248; border:1px solid #3f526b; color:#94a3b8;
        border-radius:6px; padding:5px 11px; font-size:12px;
        cursor:pointer; transition:all 0.15s; font-family:inherit;
    }
    .quick-btn:hover { background:#334155; color:#f1f5f9; border-color:#38bdf8; }

    .amount-row { display:flex; gap:8px; align-items:center; }
    .amount-input {
        flex:1; background:#0f172a; border:1px solid #334155;
        border-radius:8px; color:#f1f5f9; font-size:14px;
        padding:10px 12px; outline:none; font-family:inherit; transition:border-color 0.15s;
    }
    .amount-input:focus { border-color:#38bdf8; }

    /* 이력 */
    .section-title { font-size:14px; color:#94a3b8; text-transform:uppercase; letter-spacing:0.5px; margin-bottom:14px; }
    .type-badge { display:inline-block; font-size:11px; font-weight:700; padding:2px 8px; border-radius:4px; }
    .t-CHARGE { background:rgba(34,197,94,0.15); color:#22c55e; border:1px solid rgba(34,197,94,0.3); }
    .t-USE    { background:rgba(239,68,68,0.15);  color:#ef4444; border:1px solid rgba(239,68,68,0.3); }
    </style>
</head>
<body>
...
<div class="quick-btns">
    ...
    <table class="jsr-table">
        <thead>
        <tr>
            <th>구분</th><th>변동</th><th>잔액</th><th>내용</th><th>일시</th>
        </tr>
        </thead>
        <tbody>
